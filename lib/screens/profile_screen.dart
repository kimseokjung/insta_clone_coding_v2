...
import 'package:instagram_clone_coding/widgets/profile_body.dart';
import 'package:instagram_clone_coding/widgets/profile_side_menu.dart';
      ...
      body: Stack(
        children: <Widget>[
          AnimatedContainer(
            ...
            child: ProfileBody(userModelState,onMenuChanged: () {
              setState(() {
